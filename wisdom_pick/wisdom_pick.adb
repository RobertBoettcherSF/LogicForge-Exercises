...
package body Wisdom_Pick is
   ...
   begin
      ...
      for I in 1 .. Count loop
         declare V : Natural; begin Next_Rand (State, V, 12);
            Trials (I).Cue_Id := V; Trials (I).Proverb_Id := V; end;
      end loop;
   end Build_Session;
   ...
   begin
      ...
      for I in 1 .. Count loop
         R.Score := R.Score + Trial_Score (Trials (I).Proverb_Id, Answers (I));
      end loop;
      return R;
   end Score_Session;
end Wisdom_Pick;
