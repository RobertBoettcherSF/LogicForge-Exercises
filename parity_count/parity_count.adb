...
package body Parity_Count is
      ...
      for I in 1 .. Count loop
         ...
         begin
            ...
            for J in 1 .. 4 loop
               ...
               Trials (I).Values (J) := Pick;
               if Pick rem 2 = 1 then Odds := Odds + 1; end if;
            end loop;
            Trials (I).Odd_Count := Odds;
         end;
   ...
   begin
      ...
      for I in 1 .. Count loop
         R.Score := R.Score + Trial_Score (Trials (I).Odd_Count, Answers (I));
      end loop;
      return R;
   end Score_Session;
end Parity_Count;
