...
package Parity_Count is
   ...
   type Int_Row is array (1 .. 8) of Natural;
   type Trial is record
      Values : Int_Row := [others => 0];
      Len : Positive := 4;
      Odd_Count : Natural := 0;
   end record;
   ...
   Instruction_Key : constant String := "parity_count.instruction";
   Prompt_Key : constant String := "parity_count.prompt";
