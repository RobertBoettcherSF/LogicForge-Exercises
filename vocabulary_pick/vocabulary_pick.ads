pragma Ada_2022;
package Vocabulary_Pick is
   Max_Trials : constant Positive := 24;
   type Option_Id is range 1 .. 4;
   type Label is array (1 .. 12) of Character;
   ...
   Instruction_Key : constant String := "vocabulary_pick.instruction";
   Prompt_Key : constant String := "vocabulary_pick.prompt_choice";
