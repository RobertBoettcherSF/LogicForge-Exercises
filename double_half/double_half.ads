...
package Double_Half is
   ...
   type Mode_Kind is (Double_It, Half_It);
   type Trial is record
      Value : Natural := 0;
      Mode : Mode_Kind := Double_It;
      Result : Natural := 0;
   end record;
   ...
   Instruction_Key : constant String := "double_half.instruction";
   Prompt_Key : constant String := "double_half.prompt";
