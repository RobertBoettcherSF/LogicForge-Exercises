...
package body Guess_Letters is
   ...
   begin
      ...
      for I in 1 .. Count loop
         declare V : Natural; begin Next_Rand (State, V, 6); V := V + 2;
            Trials (I).Length_Code := V; Trials (I).Letters := V; end;
      end loop;
   end Build_Session;
   ...
   begin
      ...
      for I in 1 .. Count loop
         R.Score := R.Score + Trial_Score (Trials (I).Letters, Answers (I));
      end loop;
      return R;
   end Score_Session;
end Guess_Letters;
