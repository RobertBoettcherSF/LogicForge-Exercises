...
package body Money_Change is
   ...
   begin
      ...
      for I in 1 .. Count loop
         Next_Rand (State, Price, 50);
         Price := Price + 1;  -- 1..50
         Next_Rand (State, Extra, 30);
         Trials (I).Price := Price;
         Trials (I).Paid := Price + Extra;  -- always enough
         Trials (I).Change := Extra;
      end loop;
   end Build_Session;
   ...
   begin
      ...
      for I in 1 .. Count loop
         R.Score := R.Score + Trial_Score (Trials (I).Change, Answers (I));
      end loop;
      return R;
   end Score_Session;
end Money_Change;
