...
package Money_Change is
   ...
   Instruction_Key : constant String := "money_change.instruction";
   Prompt_Key : constant String := "money_change.prompt_change";
