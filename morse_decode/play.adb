...
begin
   ...
   Put_Line ("Decode the pulse pattern: sum the three pulse lengths, then answer mod 10.");
   Build_Session (Cfg, Trials, Count);
   for I in 1 .. Count loop
      New_Line;
      Put_Line ("Trial" & I'Image & ": pulses" & Trials (I).P1'Image & Trials (I).P2'Image & Trials (I).P3'Image);
      Put ("[" & Prompt_Key & "]: ");
      Get_Line (Line, Last);
