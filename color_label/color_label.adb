...
package body Color_Label is
   ...
   begin
      ...
      for I in 1 .. Count loop
         declare C, L : Natural; begin
            Next_Rand (State, C, 8); Next_Rand (State, L, 8);
            Trials (I).Color_Code := C; Trials (I).Label_Code := L;
            Trials (I).Match := (if C = L then 1 else 0); end;
      end loop;
   end Build_Session;
   ...
   begin
      ...
      for I in 1 .. Count loop
         R.Score := R.Score + Trial_Score (Trials (I).Match, Answers (I));
      end loop;
      return R;
   end Score_Session;
end Color_Label;
