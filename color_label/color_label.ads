...
package Color_Label is
   ...
   type Trial is record
      Color_Code, Label_Code : Natural := 1;
      Match : Natural := 1;
   end record;
   ...
   Instruction_Key : constant String := "color_label.instruction";
   Prompt_Key : constant String := "color_label.prompt";
