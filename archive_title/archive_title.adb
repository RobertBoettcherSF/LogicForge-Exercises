...
package body Archive_Title is
   ...
   begin
      ...
      for I in 1 .. Count loop
         declare V : Natural; begin Next_Rand (State, V, 20);
            Trials (I).Picture_Id := V; Trials (I).Title_Id := V; end;
      end loop;
   end Build_Session;
   ...
   begin
      ...
      for I in 1 .. Count loop
         R.Score := R.Score + Trial_Score (Trials (I).Title_Id, Answers (I));
      end loop;
      return R;
   end Score_Session;
end Archive_Title;
