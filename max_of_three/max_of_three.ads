...
package Max_Of_Three is
   ...
   Instruction_Key : constant String := "max_of_three.instruction";
   Prompt_Key : constant String := "max_of_three.prompt";
