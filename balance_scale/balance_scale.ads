...
package Balance_Scale is
   ...
   type Trial is record
      Left_A, Left_B, Right_A, Right_B : Natural := 0;
      Verdict : Natural := 0;
   end record;
   ...
   Instruction_Key : constant String := "balance_scale.instruction";
   Prompt_Key : constant String := "balance_scale.prompt";
