...
package Ufo_Count is
   ...
   type Cell_Row is array (1 .. 6) of Natural;
   type Trial is record
      Cells : Cell_Row := [others => 0];
      Target : Natural := 1;
      Hits : Natural := 0;
   end record;
   ...
   Instruction_Key : constant String := "ufo_count.instruction";
   Prompt_Key      : constant String := "ufo_count.prompt";
