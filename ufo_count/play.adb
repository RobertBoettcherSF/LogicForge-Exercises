...
begin
   ...
   Put_Line ("Count how many cells match the target value.");
   Build_Session (Cfg, Trials, Count);
   for I in 1 .. Count loop
      New_Line;
      Put ("Trial" & I'Image & " target" & Trials (I).Target'Image & " cells");
      for J in 1 .. 6 loop Put (Trials (I).Cells (J)'Image); end loop;
      New_Line;
      Put ("[" & Prompt_Key & "]: ");
      Get_Line (Line, Last);
