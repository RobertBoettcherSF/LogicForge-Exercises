...
package Subtract_Check is
   ...
   type Trial is record
      Minuend, Subtrahend, Difference : Natural := 0;
   end record;
   ...
   Instruction_Key : constant String := "subtract_check.instruction";
   Prompt_Key : constant String := "subtract_check.prompt";
