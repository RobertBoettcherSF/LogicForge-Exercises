...
package Min_Of_Three is
   ...
   Instruction_Key : constant String := "min_of_three.instruction";
   Prompt_Key : constant String := "min_of_three.prompt";
