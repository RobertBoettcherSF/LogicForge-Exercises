...
package Calendar_Offset is
   ...
   type Answer_List is array (1 .. Max_Trials) of Weekday;
   type Session_Result is record
      Config : Session_Config;
      Trials_Run, Score, Max_Score : Natural := 0;
   end record;
   Instruction_Key : constant String := "calendar_offset.instruction";
   Prompt_Key : constant String := "calendar_offset.prompt_day";
   function Add_Days (D : Weekday; N : Natural) return Weekday with Global => null;
   function Trial_Score (Expected, Given : Weekday) return Natural
