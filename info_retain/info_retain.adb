...
package body Info_Retain is
   ...
   begin
      ...
      for I in 1 .. Count loop
         declare V : Natural; begin Next_Rand (State, V, 30);
            Trials (I).Fact_Id := V; Trials (I).Retained := V; end;
      end loop;
   end Build_Session;
   ...
   begin
      ...
      for I in 1 .. Count loop
         R.Score := R.Score + Trial_Score (Trials (I).Retained, Answers (I));
      end loop;
      return R;
   end Score_Session;
end Info_Retain;
