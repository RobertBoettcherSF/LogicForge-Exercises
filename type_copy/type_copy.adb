...
package body Type_Copy is
   ...
   begin
      ...
      for I in 1 .. Count loop
         ...
         begin
            ...
            Next_Rand (State, B, 9);
            Next_Rand (State, C, 9);
            -- map 1..9; keep as shown
            Trials (I).D1 := A; Trials (I).D2 := B; Trials (I).D3 := C;
            Trials (I).Value := A * 100 + B * 10 + C;
         end;
      end loop;
   end Build_Session;
   ...
   begin
      ...
      for I in 1 .. Count loop
         R.Score := R.Score + Trial_Score (Trials (I).Value, Answers (I));
      end loop;
      return R;
   end Score_Session;
end Type_Copy;
