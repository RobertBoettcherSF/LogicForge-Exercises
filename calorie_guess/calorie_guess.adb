...
package body Calorie_Guess is
   ...
   begin
      ...
      for I in 1 .. Count loop
         declare G : Natural; begin Next_Rand (State, G, 400);
            Trials (I).Grams := G; Trials (I).Bucket := (G + 49) / 50; end;
      end loop;
   end Build_Session;
   ...
   begin
      ...
      for I in 1 .. Count loop
         R.Score := R.Score + Trial_Score (Trials (I).Bucket, Answers (I));
      end loop;
      return R;
   end Score_Session;
end Calorie_Guess;
