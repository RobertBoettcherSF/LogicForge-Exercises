pragma Ada_2022;
package body Multiply_Drill is
   ...
   begin
      ...
      for I in 1 .. Count loop
         Next_Rand (State, A, Cfg.Max_Factor);
         Next_Rand (State, B, Cfg.Max_Factor);
         Trials (I).A := A; Trials (I).B := B;
         Trials (I).Product := A * B;
      end loop;
   end Build_Session;
   ...
   begin
      ...
      for I in 1 .. Count loop
         R.Score := R.Score + Trial_Score (Trials (I).Product, Answers (I));
      end loop;
      return R;
   end Score_Session;
end Multiply_Drill;
