...
package body Alpha_Bravo is
   ...
   begin
      ...
      for I in 1 .. Count loop
         declare V : Natural; begin Next_Rand (State, V, 26);
            Trials (I).Code_Id := V; Trials (I).Letter_Index := V; end;
      end loop;
   end Build_Session;
   ...
   begin
      ...
      for I in 1 .. Count loop
         R.Score := R.Score + Trial_Score (Trials (I).Letter_Index, Answers (I));
      end loop;
      return R;
   end Score_Session;
end Alpha_Bravo;
