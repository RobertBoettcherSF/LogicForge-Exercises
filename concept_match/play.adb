...
with Concept_Match; use Concept_Match;
procedure Play is
...
begin
   ...
   Put_Line ("1 if cue matches category, else 0.");
   Build_Session (Cfg, Trials, Count);
   for I in 1 .. Count loop
      New_Line;
      Put_Line ("Trial" & I'Image & ": cue" & Trials (I).Cue'Image & " cat" & Trials (I).Category'Image);
      Put ("[" & Prompt_Key & "]: ");
      Get_Line (Line, Last);
