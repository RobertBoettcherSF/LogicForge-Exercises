...
package Concept_Match is
   ...
   Instruction_Key : constant String := "concept_match.instruction";
   Prompt_Key : constant String := "concept_match.prompt";
