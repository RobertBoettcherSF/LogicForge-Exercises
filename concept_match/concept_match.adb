...
package body Concept_Match is
   ...
   begin
      ...
      for I in 1 .. Count loop
         declare C, K : Natural; begin Next_Rand (State, C, 10); Next_Rand (State, K, 10);
            Trials (I).Cue := C; Trials (I).Category := K;
            Trials (I).Match := (if C = K then 1 else 0); end;
      end loop;
   end Build_Session;
