...
package Labyrinth_Turn is
   ...
   Instruction_Key : constant String := "labyrinth_turn.instruction";
   Prompt_Key : constant String := "labyrinth_turn.prompt";
