pragma Ada_2022;
package body Dictation_Echo is
   ...
   begin
      ...
      for I in 1 .. Count loop
         declare V : Natural; begin Next_Rand (State, V, 900);
            Trials (I).Code := V; Trials (I).Echo := V; end;
      end loop;
   end Build_Session;
   ...
   begin
      ...
      for I in 1 .. Count loop
         R.Score := R.Score + Trial_Score (Trials (I).Echo, Answers (I));
      end loop;
      return R;
   end Score_Session;
end Dictation_Echo;
